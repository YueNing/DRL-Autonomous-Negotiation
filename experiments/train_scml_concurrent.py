"""
Experiment for concurrent negotiation control, with algorithm MADDPG, single thread
"""
...
result = model.learn(train_episodes=10)

show_ep_rewards(result.total_final_ep_rewards, model, extra=True)
show_agent_rewards(result.total_final_ep_ag_rewards, model, extra=True)
